...
public class Pesca_Marcos_Rabadan {
            ...
            while (bandera) {
                ...
                switch (opcion) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Scanner scUsuarioEs = new Scanner(System.in);
                        System.out.print("Usuario: ");
                        String opcionUsuarioEstadistica = scUsuarioEs.nextLine();
                        identificacion(pathUsuarios, 2, opcionUsuarioEstadistica);
                        mostrarEstadisticasUsuarios(pathRegistros, opcionUsuarioEstadistica);
                        break;
                    case 5:
    ...
    public static void main(String[] args) throws Exception {
        Pesca_Marcos_Rabadan pescaMarcosRabadan = new Pesca_Marcos_Rabadan();
        pescaMarcosRabadan.menu();
    }
}
